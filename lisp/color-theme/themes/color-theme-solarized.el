    ...
    (let ((background (first backgrounds))
      ...
      (color-theme-install
       `(,(intern (concat "color-theme-solarized-" (symbol-name mode)))
         ...
         (font-lock-warning-face ((t (:underline t :foreground ,red))))
         ...
         (isearch-lazy-highlight-search ((t (:underline t :foreground ,yellow))))
	 ...
	 (ido-subdir ((t (:foreground ,magenta))))
         ...
         ;; Emacs interface
         (fringe ((t (:foreground ,faint :background ,background))))
